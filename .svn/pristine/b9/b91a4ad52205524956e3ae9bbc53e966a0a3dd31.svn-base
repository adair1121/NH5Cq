...
(function (data) {
    ...
    (function (PlayerAttr) {
        ...
        * 称号ID
        **/
        PlayerAttr[PlayerAttr["titleId"] = 42] = "titleId";
        /**
        * 当前关卡ID
        **/
        ...
        * 公会捐献元宝剩余次数
        **/
        PlayerAttr[PlayerAttr["donate_gold_remaincount"] = 54] = "donate_gold_remaincount";
        /**
        * 公会捐献金币剩余次数
        **/
        PlayerAttr[PlayerAttr["donate_money_remaincount"] = 55] = "donate_money_remaincount";
        /**
        * 注灵
        **/
        PlayerAttr[PlayerAttr["zhuling"] = 56] = "zhuling";
        /**
        * 声望
        **/
        PlayerAttr[PlayerAttr["shengwang"] = 57] = "shengwang";
        /**
        * 上次月卡领取奖励时间秒数
        **/
        PlayerAttr[PlayerAttr["lastMonthCardAwardTime"] = 58] = "lastMonthCardAwardTime";
        /**
        * 7日排行-宝石
        **/
        PlayerAttr[PlayerAttr["rankTime_Day7BaoShi"] = 59] = "rankTime_Day7BaoShi";
        /**
        * 7日排行-翅膀
        **/
        PlayerAttr[PlayerAttr["rankTime_Day7ChiBang"] = 60] = "rankTime_Day7ChiBang";
        /**
        * 7日排行-等级
        **/
        PlayerAttr[PlayerAttr["rankTime_Day7DengJi"] = 61] = "rankTime_Day7DengJi";
        /**
        * 7日排行-护盾
        **/
        PlayerAttr[PlayerAttr["rankTime_Day7HuDun"] = 62] = "rankTime_Day7HuDun";
        /**
        * 7日排行-战灵
        **/
        PlayerAttr[PlayerAttr["rankTime_Day7ZhanLing"] = 63] = "rankTime_Day7ZhanLing";
        /**
        * 7日排行-战力
        **/
        PlayerAttr[PlayerAttr["rankTime_Day7ZhanLi"] = 64] = "rankTime_Day7ZhanLi";
        /**
        * 7日排行-龙魂
        **/
        PlayerAttr[PlayerAttr["rankTime_Day7LongHun"] = 65] = "rankTime_Day7LongHun";
        PlayerAttr[PlayerAttr["MAX"] = 66] = "MAX";
    ...
    (function (GuildJob) {
        ...
        * 成员0
        **/
        GuildJob[GuildJob["ChengYuan"] = 0] = "ChengYuan";
        /**
        * 长老1
        **/
        GuildJob[GuildJob["ZhangLao"] = 1] = "ZhangLao";
        /**
        * 副会长2
        **/
        ...
        * 会长3
        **/
        GuildJob[GuildJob["HuiZhang"] = 3] = "HuiZhang";
    ...
    (function (SenceType) {
        ...
        **/
        ...
        SenceType[SenceType["PersonalBoss"] = 3] = "PersonalBoss";
        SenceType[SenceType["WorldBoss"] = 4] = "WorldBoss";
        SenceType[SenceType["MeetBattle"] = 5] = "MeetBattle";
    ...
    var GuildNotifyType;
    (function (GuildNotifyType) {
        /**
        * 批准入会
        **/
        GuildNotifyType[GuildNotifyType["Add"] = 1] = "Add";
        /**
        * 职位改变
        **/
        GuildNotifyType[GuildNotifyType["dutyChange"] = 2] = "dutyChange";
        /**
        * 离开公会
        **/
        GuildNotifyType[GuildNotifyType["Leave"] = 3] = "Leave";
        /**
        * 解散公会
        **/
        GuildNotifyType[GuildNotifyType["Break"] = 4] = "Break";
    })(GuildNotifyType = data.GuildNotifyType || (data.GuildNotifyType = {}));
    var ReceiveType;
    (function (ReceiveType) {
        /**
        * 每周累计充值
        **/
        ReceiveType[ReceiveType["weekCharge"] = 1] = "weekCharge";
        /**
        * 每天连续充值(3个档位)
        **/
        ReceiveType[ReceiveType["continueChange"] = 2] = "continueChange";
    })(ReceiveType = data.ReceiveType || (data.ReceiveType = {}));
    var ItemType;
    (function (ItemType) {
        /**
        * 武器
