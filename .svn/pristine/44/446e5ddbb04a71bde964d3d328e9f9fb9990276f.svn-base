...
(function (proto) {
    var MessageHandle = (function () {
        function MessageHandle() {
            ...
            this.commands[proto.MessageType.s_GuildInfo] = this.do_s_GuildInfo;
            this.commands[proto.MessageType.s_CreateGuild] = this.do_s_CreateGuild;
            this.commands[proto.MessageType.s_GuildList] = this.do_s_GuildList;
            this.commands[proto.MessageType.s_EnterGuild] = this.do_s_EnterGuild;
            this.commands[proto.MessageType.s_LeaveGuild] = this.do_s_LeaveGuild;
            this.commands[proto.MessageType.s_GuildApprove] = this.do_s_GuildApprove;
            this.commands[proto.MessageType.s_GuildNotify] = this.do_s_GuildNotify;
            this.commands[proto.MessageType.s_AdjustGuildDuty] = this.do_s_AdjustGuildDuty;
            this.commands[proto.MessageType.s_ChangeTitle] = this.do_s_ChangeTitle;
            this.commands[proto.MessageType.s_GuildUpgrade] = this.do_s_GuildUpgrade;
            this.commands[proto.MessageType.s_GuildSkillStrengthen] = this.do_s_GuildSkillStrengthen;
            this.commands[proto.MessageType.s_GuildDonate] = this.do_s_GuildDonate;
            this.commands[proto.MessageType.s_GetIntervalChargeData] = this.do_s_GetIntervalChargeData;
            this.commands[proto.MessageType.s_GetContinuChargeData] = this.do_s_GetContinuChargeData;
            this.commands[proto.MessageType.s_ReceiveRewards] = this.do_s_ReceiveRewards;
            this.commands[proto.MessageType.s_GuildBattleReq] = this.do_s_GuildBattleReq;
            this.commands[proto.MessageType.s_GuildChangeScene] = this.do_s_GuildChangeScene;
            this.commands[proto.MessageType.s_SyncSceneRole] = this.do_s_SyncSceneRole;
        ...
        MessageHandle.prototype.do_s_GuildInfo = function (mess) { };
        MessageHandle.prototype.do_s_CreateGuild = function (mess) { };
        MessageHandle.prototype.do_s_GuildList = function (mess) { };
        MessageHandle.prototype.do_s_EnterGuild = function (mess) { };
        MessageHandle.prototype.do_s_LeaveGuild = function (mess) { };
        MessageHandle.prototype.do_s_GuildApprove = function (mess) { };
        MessageHandle.prototype.do_s_GuildNotify = function (mess) { };
        MessageHandle.prototype.do_s_AdjustGuildDuty = function (mess) { };
        MessageHandle.prototype.do_s_ChangeTitle = function (mess) { };
        MessageHandle.prototype.do_s_GuildUpgrade = function (mess) { };
        MessageHandle.prototype.do_s_GuildSkillStrengthen = function (mess) { };
        MessageHandle.prototype.do_s_GuildDonate = function (mess) { };
        MessageHandle.prototype.do_s_GetIntervalChargeData = function (mess) { };
        MessageHandle.prototype.do_s_GetContinuChargeData = function (mess) { };
        MessageHandle.prototype.do_s_ReceiveRewards = function (mess) { };
        MessageHandle.prototype.do_s_GuildBattleReq = function (mess) { };
        MessageHandle.prototype.do_s_GuildChangeScene = function (mess) { };
        MessageHandle.prototype.do_s_SyncSceneRole = function (mess) { };
