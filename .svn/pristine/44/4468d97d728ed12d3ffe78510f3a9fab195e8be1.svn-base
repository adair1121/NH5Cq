module data{
	...
	export enum PlayerAttr{
		...
		* 公会捐献元宝剩余次数
		**/
		donate_gold_remaincount=54,
		/**
		* 公会捐献金币剩余次数
		**/
		donate_money_remaincount=55,
		/**
		* 注灵
		**/
		zhuling=56,
		...
		* 上次月卡领取奖励时间秒数
		**/
		lastMonthCardAwardTime=58,
		/**
		* 7日排行-宝石
		**/
		rankTime_Day7BaoShi=59,
		/**
		* 7日排行-翅膀
		**/
		rankTime_Day7ChiBang=60,
		/**
		* 7日排行-等级
		**/
		rankTime_Day7DengJi=61,
		/**
		* 7日排行-护盾
		**/
		rankTime_Day7HuDun=62,
		/**
		* 7日排行-战灵
		**/
		rankTime_Day7ZhanLing=63,
		/**
		* 7日排行-战力
		**/
		rankTime_Day7ZhanLi=64,
		/**
		* 7日排行-龙魂
		**/
		rankTime_Day7LongHun=65,
		MAX=66,
	}
