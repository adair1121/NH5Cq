...
(function (proto) {
    ...
    var c_DisassembleEquip = (function (_super) {
        ...
        c_DisassembleEquip.prototype.init = function (_equipInstId) {
    ...
    var c_MeetBattle = (function (_super) {
        ...
        c_MeetBattle.prototype.init = function (_isCostGold) {
            this.isCostGold = _isCostGold;
            return this;
        };
        c_MeetBattle.prototype.encode = function (by) {
            by.writeBoolean(this.isCostGold);
        };
        c_MeetBattle.prototype.decode = function (by) {
            this.isCostGold = by.readBoolean();
        };
        return c_MeetBattle;
    }(proto.Pro));
    ...
    var s_MeetBattle = (function (_super) {
        ...
        s_MeetBattle.prototype.init = function (_isSuccess, _errMsg, _meetPlayer, _refreshTime) {
            this.isSuccess = _isSuccess;
            this.errMsg = _errMsg;
            this.meetPlayer = _meetPlayer;
        ...
        s_MeetBattle.prototype.encode = function (by) {
            ...
            if (this.meetPlayer != null) {
                by.writeByte(1);
                this.meetPlayer.encode(by);
            }
            else {
                by.writeByte(0);
            }
        ...
        s_MeetBattle.prototype.decode = function (by) {
            ...
            if (by.readByte() > 0) {
                this.meetPlayer = new RankInfo();
                this.meetPlayer.decode(by);
            }
            if (by.readByte() > 0) {
    ...
    var s_MeetKill = (function (_super) {
        ...
        s_MeetKill.prototype.init = function (_isSuccess, _errMsg, _isWin, _actList, _refreshTime) {
            this.isSuccess = _isSuccess;
            this.errMsg = _errMsg;
            this.isWin = _isWin;
            this.actList = _actList;
    ...
    var s_GuildInfo = (function (_super) {
        __extends(s_GuildInfo, _super);
        function s_GuildInfo() {
            var _this = _super.call(this) || this;
            //required>int
            ...
            _this.gold = 0; //公会资金
            //required>int
            _this.needFightValue = 0; //自动同意需要战力值
            _this.S = proto.MessageType.s_GuildInfo;
            return _this;
        }
        s_GuildInfo.prototype.init = function (_guildLv, _gold, _memberList, _notice, _requstList, _isAutoApprove, _needFightValue) {
            this.guildLv = _guildLv;
            this.gold = _gold;
            this.memberList = _memberList;
            this.notice = _notice;
            this.requstList = _requstList;
            this.isAutoApprove = _isAutoApprove;
            this.needFightValue = _needFightValue;
            return this;
        };
        s_GuildInfo.prototype.encode = function (by) {
            ...
            by.writeBoolean(this.isAutoApprove);
            by.writeInt(this.needFightValue);
        };
        s_GuildInfo.prototype.decode = function (by) {
            ...
            this.isAutoApprove = by.readBoolean();
            this.needFightValue = by.readInt();
        };
        return s_GuildInfo;
    }(proto.Pro));
    proto.s_GuildInfo = s_GuildInfo;
    __reflect(s_GuildInfo.prototype, "proto.s_GuildInfo");
    ...
    var c_CreateGuild = (function (_super) {
        __extends(c_CreateGuild, _super);
        function c_CreateGuild() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.c_CreateGuild;
            return _this;
        }
        c_CreateGuild.prototype.init = function (_name) {
            this.name = _name;
            return this;
        };
        c_CreateGuild.prototype.encode = function (by) {
            by.writeUTF(this.name);
        };
        c_CreateGuild.prototype.decode = function (by) {
            this.name = by.readUTF();
        };
        return c_CreateGuild;
    }(proto.Pro));
    proto.c_CreateGuild = c_CreateGuild;
    __reflect(c_CreateGuild.prototype, "proto.c_CreateGuild");
    var s_CreateGuild = (function (_super) {
        __extends(s_CreateGuild, _super);
        function s_CreateGuild() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.s_CreateGuild;
            return _this;
        }
        s_CreateGuild.prototype.init = function (_isSuccess, _errMsg) {
            this.isSuccess = _isSuccess;
            this.errMsg = _errMsg;
            return this;
        };
        s_CreateGuild.prototype.encode = function (by) {
            by.writeBoolean(this.isSuccess);
            if (this.errMsg != null) {
                by.writeByte(1);
                by.writeUTF(this.errMsg);
        ...
        s_CreateGuild.prototype.decode = function (by) {
            this.isSuccess = by.readBoolean();
            if (by.readByte() > 0) {
                this.errMsg = by.readUTF();
            }
        };
        return s_CreateGuild;
    }(proto.Pro));
    proto.s_CreateGuild = s_CreateGuild;
    __reflect(s_CreateGuild.prototype, "proto.s_CreateGuild");
    var c_GuildList = (function (_super) {
        __extends(c_GuildList, _super);
        function c_GuildList() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.c_GuildList;
            return _this;
        }
        c_GuildList.prototype.init = function () {
            return this;
        };
        c_GuildList.prototype.encode = function (by) {
        };
        c_GuildList.prototype.decode = function (by) {
        };
        return c_GuildList;
    }(proto.Pro));
    proto.c_GuildList = c_GuildList;
    __reflect(c_GuildList.prototype, "proto.c_GuildList");
    var s_GuildList = (function (_super) {
        ...
        s_GuildList.prototype.init = function (_infoList) {
            this.infoList = _infoList;
            return this;
        };
        s_GuildList.prototype.encode = function (by) {
            if (this.infoList != null) {
                by.writeShort(this.infoList.length);
                for (var i = 0; i < this.infoList.length; i++) {
                    this.infoList[i].encode(by);
                }
            }
            else {
                by.writeShort(0);
        ...
        s_GuildList.prototype.decode = function (by) {
            ...
            this.infoList = [];
            for (var i = 0; i < __count0; i++) {
                this.infoList[i] = new GuildBasicInfo();
                this.infoList[i].decode(by);
            }
        };
        return s_GuildList;
    }(proto.Pro));
    ...
    var GuildBasicInfo = (function (_super) {
        __extends(GuildBasicInfo, _super);
        function GuildBasicInfo() {
            var _this = _super.call(this) || this;
            //required>int
            _this.guildLv = 0; //公会等级
            //required>int
            _this.guildGold = 0; //公会资金
            //required>int
            _this.currPlayerCount = 0; //公会当前人数
            _this.S = proto.MessageType.GuildBasicInfo;
            return _this;
        }
        GuildBasicInfo.prototype.init = function (_guildId, _guildName, _creatorName, _guildLv, _guildGold, _currPlayerCount) {
            this.guildId = _guildId;
            this.guildName = _guildName;
            this.creatorName = _creatorName;
            this.guildLv = _guildLv;
            this.guildGold = _guildGold;
            this.currPlayerCount = _currPlayerCount;
            return this;
        };
        GuildBasicInfo.prototype.encode = function (by) {
            by.writeUTF(this.guildId);
            by.writeUTF(this.guildName);
            by.writeUTF(this.creatorName);
            by.writeInt(this.guildLv);
            by.writeInt(this.guildGold);
            by.writeInt(this.currPlayerCount);
        };
        GuildBasicInfo.prototype.decode = function (by) {
            this.guildId = by.readUTF();
            this.guildName = by.readUTF();
            this.creatorName = by.readUTF();
            this.guildLv = by.readInt();
            this.guildGold = by.readInt();
            this.currPlayerCount = by.readInt();
        };
        return GuildBasicInfo;
    }(proto.Pro));
    proto.GuildBasicInfo = GuildBasicInfo;
    __reflect(GuildBasicInfo.prototype, "proto.GuildBasicInfo");
    var c_EnterGuild = (function (_super) {
        __extends(c_EnterGuild, _super);
        function c_EnterGuild() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.c_EnterGuild;
            return _this;
        }
        c_EnterGuild.prototype.init = function (_guildId) {
            this.guildId = _guildId;
            return this;
        };
        c_EnterGuild.prototype.encode = function (by) {
            by.writeUTF(this.guildId);
        };
        c_EnterGuild.prototype.decode = function (by) {
            this.guildId = by.readUTF();
        };
        return c_EnterGuild;
    }(proto.Pro));
    proto.c_EnterGuild = c_EnterGuild;
    __reflect(c_EnterGuild.prototype, "proto.c_EnterGuild");
    var s_EnterGuild = (function (_super) {
        __extends(s_EnterGuild, _super);
        function s_EnterGuild() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.s_EnterGuild;
            return _this;
        }
        s_EnterGuild.prototype.init = function (_isSuccess, _errMsg) {
            this.isSuccess = _isSuccess;
            this.errMsg = _errMsg;
            return this;
        };
        s_EnterGuild.prototype.encode = function (by) {
            by.writeBoolean(this.isSuccess);
            if (this.errMsg != null) {
                by.writeByte(1);
                by.writeUTF(this.errMsg);
        ...
        s_EnterGuild.prototype.decode = function (by) {
            this.isSuccess = by.readBoolean();
            if (by.readByte() > 0) {
                this.errMsg = by.readUTF();
            }
    ...
    proto.s_EnterGuild = s_EnterGuild;
    __reflect(s_EnterGuild.prototype, "proto.s_EnterGuild");
    var c_LeaveGuild = (function (_super) {
        __extends(c_LeaveGuild, _super);
        function c_LeaveGuild() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.c_LeaveGuild;
            return _this;
        }
        c_LeaveGuild.prototype.init = function () {
            return this;
        };
        c_LeaveGuild.prototype.encode = function (by) {
        };
        c_LeaveGuild.prototype.decode = function (by) {
        };
        return c_LeaveGuild;
    }(proto.Pro));
    proto.c_LeaveGuild = c_LeaveGuild;
    __reflect(c_LeaveGuild.prototype, "proto.c_LeaveGuild");
    var s_LeaveGuild = (function (_super) {
        __extends(s_LeaveGuild, _super);
        function s_LeaveGuild() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.s_LeaveGuild;
            return _this;
        }
        s_LeaveGuild.prototype.init = function (_isSuccess, _errMsg) {
            this.isSuccess = _isSuccess;
            this.errMsg = _errMsg;
            return this;
        };
        s_LeaveGuild.prototype.encode = function (by) {
            by.writeBoolean(this.isSuccess);
            if (this.errMsg != null) {
                by.writeByte(1);
                by.writeUTF(this.errMsg);
        ...
        s_LeaveGuild.prototype.decode = function (by) {
            this.isSuccess = by.readBoolean();
            if (by.readByte() > 0) {
                this.errMsg = by.readUTF();
            }
    ...
    proto.s_LeaveGuild = s_LeaveGuild;
    __reflect(s_LeaveGuild.prototype, "proto.s_LeaveGuild");
    var c_GuildApprove = (function (_super) {
        __extends(c_GuildApprove, _super);
        function c_GuildApprove() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.c_GuildApprove;
            return _this;
        }
        c_GuildApprove.prototype.init = function (_playerId) {
            this.playerId = _playerId;
            return this;
        };
        c_GuildApprove.prototype.encode = function (by) {
            by.writeUTF(this.playerId);
        };
        c_GuildApprove.prototype.decode = function (by) {
            this.playerId = by.readUTF();
        };
        return c_GuildApprove;
    }(proto.Pro));
    proto.c_GuildApprove = c_GuildApprove;
    __reflect(c_GuildApprove.prototype, "proto.c_GuildApprove");
    var s_GuildApprove = (function (_super) {
        __extends(s_GuildApprove, _super);
        function s_GuildApprove() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.s_GuildApprove;
            return _this;
        }
        s_GuildApprove.prototype.init = function (_isSuccess, _errMsg) {
            this.isSuccess = _isSuccess;
            this.errMsg = _errMsg;
            return this;
        };
        s_GuildApprove.prototype.encode = function (by) {
            by.writeBoolean(this.isSuccess);
            if (this.errMsg != null) {
                by.writeByte(1);
                by.writeUTF(this.errMsg);
        ...
        s_GuildApprove.prototype.decode = function (by) {
            this.isSuccess = by.readBoolean();
            if (by.readByte() > 0) {
                this.errMsg = by.readUTF();
            }
        };
        return s_GuildApprove;
    }(proto.Pro));
    proto.s_GuildApprove = s_GuildApprove;
    __reflect(s_GuildApprove.prototype, "proto.s_GuildApprove");
    var s_GuildNotify = (function (_super) {
        __extends(s_GuildNotify, _super);
        function s_GuildNotify() {
            var _this = _super.call(this) || this;
            //required>int
            _this.type = 0; //1:批准入会2:职位变动3:离开公会4:解散公会
            _this.S = proto.MessageType.s_GuildNotify;
            return _this;
        }
        s_GuildNotify.prototype.init = function (_type, _memberData) {
            this.type = _type;
            this.memberData = _memberData;
            return this;
        };
        s_GuildNotify.prototype.encode = function (by) {
            by.writeInt(this.type);
            if (this.memberData != null) {
                by.writeByte(1);
                this.memberData.encode(by);
            }
            else {
                by.writeByte(0);
            }
        };
        s_GuildNotify.prototype.decode = function (by) {
            this.type = by.readInt();
            if (by.readByte() > 0) {
                this.memberData = new GuildMemberData();
                this.memberData.decode(by);
            }
        };
        return s_GuildNotify;
    }(proto.Pro));
    proto.s_GuildNotify = s_GuildNotify;
    __reflect(s_GuildNotify.prototype, "proto.s_GuildNotify");
    var c_AdjustGuildDuty = (function (_super) {
        __extends(c_AdjustGuildDuty, _super);
        function c_AdjustGuildDuty() {
            var _this = _super.call(this) || this;
            //required>int
            _this.duty = 0; //调整到什么职位
            _this.S = proto.MessageType.c_AdjustGuildDuty;
            return _this;
        }
        c_AdjustGuildDuty.prototype.init = function (_playerId, _duty) {
            this.playerId = _playerId;
            this.duty = _duty;
            return this;
        };
        c_AdjustGuildDuty.prototype.encode = function (by) {
            by.writeUTF(this.playerId);
            by.writeInt(this.duty);
        };
        c_AdjustGuildDuty.prototype.decode = function (by) {
            this.playerId = by.readUTF();
            this.duty = by.readInt();
        };
        return c_AdjustGuildDuty;
    }(proto.Pro));
    proto.c_AdjustGuildDuty = c_AdjustGuildDuty;
    __reflect(c_AdjustGuildDuty.prototype, "proto.c_AdjustGuildDuty");
    var s_AdjustGuildDuty = (function (_super) {
        __extends(s_AdjustGuildDuty, _super);
        function s_AdjustGuildDuty() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.s_AdjustGuildDuty;
            return _this;
        }
        s_AdjustGuildDuty.prototype.init = function (_isSuccess, _errMsg) {
            this.isSuccess = _isSuccess;
            this.errMsg = _errMsg;
            return this;
        };
        s_AdjustGuildDuty.prototype.encode = function (by) {
            by.writeBoolean(this.isSuccess);
            if (this.errMsg != null) {
                by.writeByte(1);
                by.writeUTF(this.errMsg);
        ...
        s_AdjustGuildDuty.prototype.decode = function (by) {
            this.isSuccess = by.readBoolean();
            if (by.readByte() > 0) {
                this.errMsg = by.readUTF();
            }
        };
        return s_AdjustGuildDuty;
    }(proto.Pro));
    proto.s_AdjustGuildDuty = s_AdjustGuildDuty;
    __reflect(s_AdjustGuildDuty.prototype, "proto.s_AdjustGuildDuty");
    var c_ChangeTitle = (function (_super) {
        __extends(c_ChangeTitle, _super);
        function c_ChangeTitle() {
            var _this = _super.call(this) || this;
            //required>int
            _this.titleId = 0; //称号ID
            _this.S = proto.MessageType.c_ChangeTitle;
            return _this;
        }
        c_ChangeTitle.prototype.init = function (_titleId) {
            this.titleId = _titleId;
            return this;
        };
        c_ChangeTitle.prototype.encode = function (by) {
            by.writeInt(this.titleId);
        };
        c_ChangeTitle.prototype.decode = function (by) {
            this.titleId = by.readInt();
        };
        return c_ChangeTitle;
    }(proto.Pro));
    proto.c_ChangeTitle = c_ChangeTitle;
    __reflect(c_ChangeTitle.prototype, "proto.c_ChangeTitle");
    var s_ChangeTitle = (function (_super) {
        __extends(s_ChangeTitle, _super);
        function s_ChangeTitle() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.s_ChangeTitle;
            return _this;
        }
        s_ChangeTitle.prototype.init = function (_isSuccess, _errMsg) {
            this.isSuccess = _isSuccess;
            this.errMsg = _errMsg;
            return this;
        };
        s_ChangeTitle.prototype.encode = function (by) {
            by.writeBoolean(this.isSuccess);
            if (this.errMsg != null) {
                by.writeByte(1);
                by.writeUTF(this.errMsg);
        ...
        s_ChangeTitle.prototype.decode = function (by) {
            this.isSuccess = by.readBoolean();
            if (by.readByte() > 0) {
                this.errMsg = by.readUTF();
            }
        };
        return s_ChangeTitle;
    }(proto.Pro));
    proto.s_ChangeTitle = s_ChangeTitle;
    __reflect(s_ChangeTitle.prototype, "proto.s_ChangeTitle");
    var c_GuildUpgrade = (function (_super) {
        __extends(c_GuildUpgrade, _super);
        function c_GuildUpgrade() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.c_GuildUpgrade;
            return _this;
        }
        c_GuildUpgrade.prototype.init = function () {
            return this;
        };
        c_GuildUpgrade.prototype.encode = function (by) {
        };
        c_GuildUpgrade.prototype.decode = function (by) {
        };
        return c_GuildUpgrade;
    }(proto.Pro));
    proto.c_GuildUpgrade = c_GuildUpgrade;
    __reflect(c_GuildUpgrade.prototype, "proto.c_GuildUpgrade");
    var s_GuildUpgrade = (function (_super) {
        __extends(s_GuildUpgrade, _super);
        function s_GuildUpgrade() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.s_GuildUpgrade;
            return _this;
        }
        s_GuildUpgrade.prototype.init = function (_isSuccess, _errMsg) {
            this.isSuccess = _isSuccess;
            this.errMsg = _errMsg;
            return this;
        };
        s_GuildUpgrade.prototype.encode = function (by) {
            by.writeBoolean(this.isSuccess);
            if (this.errMsg != null) {
                by.writeByte(1);
                by.writeUTF(this.errMsg);
        ...
        s_GuildUpgrade.prototype.decode = function (by) {
            this.isSuccess = by.readBoolean();
            if (by.readByte() > 0) {
                this.errMsg = by.readUTF();
            }
        };
        return s_GuildUpgrade;
    }(proto.Pro));
    proto.s_GuildUpgrade = s_GuildUpgrade;
    __reflect(s_GuildUpgrade.prototype, "proto.s_GuildUpgrade");
    var c_GuildSkillStrengthen = (function (_super) {
        __extends(c_GuildSkillStrengthen, _super);
        function c_GuildSkillStrengthen() {
            var _this = _super.call(this) || this;
            //required>int
            _this.type = 0; //强化类型
            _this.S = proto.MessageType.c_GuildSkillStrengthen;
            return _this;
        }
        c_GuildSkillStrengthen.prototype.init = function (_type) {
            this.type = _type;
            return this;
        };
        c_GuildSkillStrengthen.prototype.encode = function (by) {
            by.writeInt(this.type);
        };
        c_GuildSkillStrengthen.prototype.decode = function (by) {
            this.type = by.readInt();
        };
        return c_GuildSkillStrengthen;
    }(proto.Pro));
    proto.c_GuildSkillStrengthen = c_GuildSkillStrengthen;
    __reflect(c_GuildSkillStrengthen.prototype, "proto.c_GuildSkillStrengthen");
    var s_GuildSkillStrengthen = (function (_super) {
        __extends(s_GuildSkillStrengthen, _super);
        function s_GuildSkillStrengthen() {
            var _this = _super.call(this) || this;
            //optional>int
            _this.newID = 0; //新的ID
            _this.S = proto.MessageType.s_GuildSkillStrengthen;
            return _this;
        }
        s_GuildSkillStrengthen.prototype.init = function (_isSuccess, _errMsg, _newID) {
            this.isSuccess = _isSuccess;
            this.errMsg = _errMsg;
            this.newID = _newID;
            return this;
        };
        s_GuildSkillStrengthen.prototype.encode = function (by) {
            by.writeBoolean(this.isSuccess);
            if (this.errMsg != null) {
                by.writeByte(1);
                by.writeUTF(this.errMsg);
        ...
        s_GuildSkillStrengthen.prototype.decode = function (by) {
            this.isSuccess = by.readBoolean();
            if (by.readByte() > 0) {
                this.errMsg = by.readUTF();
            }
        ...
        return s_GuildSkillStrengthen;
    }(proto.Pro));
    proto.s_GuildSkillStrengthen = s_GuildSkillStrengthen;
    __reflect(s_GuildSkillStrengthen.prototype, "proto.s_GuildSkillStrengthen");
    var c_GuildDonate = (function (_super) {
        __extends(c_GuildDonate, _super);
        function c_GuildDonate() {
            var _this = _super.call(this) || this;
            //required>int
            _this.templateId = 0; //捐献模版ID
            _this.S = proto.MessageType.c_GuildDonate;
            return _this;
        }
        c_GuildDonate.prototype.init = function (_templateId) {
            this.templateId = _templateId;
            return this;
        };
        c_GuildDonate.prototype.encode = function (by) {
            by.writeInt(this.templateId);
        };
        c_GuildDonate.prototype.decode = function (by) {
            this.templateId = by.readInt();
        };
        return c_GuildDonate;
    }(proto.Pro));
    proto.c_GuildDonate = c_GuildDonate;
    __reflect(c_GuildDonate.prototype, "proto.c_GuildDonate");
    var s_GuildDonate = (function (_super) {
        __extends(s_GuildDonate, _super);
        function s_GuildDonate() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.s_GuildDonate;
            return _this;
        }
        s_GuildDonate.prototype.init = function (_isSuccess, _errMsg) {
            this.isSuccess = _isSuccess;
            this.errMsg = _errMsg;
            return this;
        };
        s_GuildDonate.prototype.encode = function (by) {
            by.writeBoolean(this.isSuccess);
            if (this.errMsg != null) {
                by.writeByte(1);
                by.writeUTF(this.errMsg);
        ...
        s_GuildDonate.prototype.decode = function (by) {
            this.isSuccess = by.readBoolean();
            if (by.readByte() > 0) {
                this.errMsg = by.readUTF();
            }
        };
        return s_GuildDonate;
    }(proto.Pro));
    proto.s_GuildDonate = s_GuildDonate;
    __reflect(s_GuildDonate.prototype, "proto.s_GuildDonate");
    var s_GetIntervalChargeData = (function (_super) {
        __extends(s_GetIntervalChargeData, _super);
        function s_GetIntervalChargeData() {
            var _this = _super.call(this) || this;
            //required>int
            _this.chargeRmbValue = 0; //充值rmb数量
            _this.S = proto.MessageType.s_GetIntervalChargeData;
            return _this;
        }
        s_GetIntervalChargeData.prototype.init = function (_chargeRmbValue, _isGot, _errMsg) {
            this.chargeRmbValue = _chargeRmbValue;
            this.isGot = _isGot;
            this.errMsg = _errMsg;
            return this;
        };
        s_GetIntervalChargeData.prototype.encode = function (by) {
            by.writeInt(this.chargeRmbValue);
            if (this.isGot != null) {
                by.writeShort(this.isGot.length);
                for (var i = 0; i < this.isGot.length; i++) {
                    by.writeBoolean(this.isGot[i]);
                }
            }
            else {
                by.writeShort(0);
        ...
        s_GetIntervalChargeData.prototype.decode = function (by) {
            this.chargeRmbValue = by.readInt();
            var __count1 = by.readShort();
            this.isGot = [];
            for (var i = 0; i < __count1; i++) {
                this.isGot[i] = by.readBoolean();
            }
            if (by.readByte() > 0) {
                this.errMsg = by.readUTF();
            }
        };
        return s_GetIntervalChargeData;
    }(proto.Pro));
    proto.s_GetIntervalChargeData = s_GetIntervalChargeData;
    __reflect(s_GetIntervalChargeData.prototype, "proto.s_GetIntervalChargeData");
    var s_GetContinuChargeData = (function (_super) {
        __extends(s_GetContinuChargeData, _super);
        function s_GetContinuChargeData() {
            var _this = _super.call(this) || this;
            //required>int
            _this.dayChargeRmbValue = 0; //当天充值rmb数量
            _this.S = proto.MessageType.s_GetContinuChargeData;
            return _this;
        }
        s_GetContinuChargeData.prototype.init = function (_dayChargeRmbValue, _isGot, _errMsg) {
            this.dayChargeRmbValue = _dayChargeRmbValue;
            this.isGot = _isGot;
            this.errMsg = _errMsg;
            return this;
        };
        s_GetContinuChargeData.prototype.encode = function (by) {
            by.writeInt(this.dayChargeRmbValue);
            if (this.isGot != null) {
                by.writeShort(this.isGot.length);
                for (var i = 0; i < this.isGot.length; i++) {
                    by.writeBoolean(this.isGot[i]);
        ...
        s_GetContinuChargeData.prototype.decode = function (by) {
            this.dayChargeRmbValue = by.readInt();
            var __count1 = by.readShort();
            this.isGot = [];
            for (var i = 0; i < __count1; i++) {
                this.isGot[i] = by.readBoolean();
        ...
        return s_GetContinuChargeData;
    }(proto.Pro));
    proto.s_GetContinuChargeData = s_GetContinuChargeData;
    __reflect(s_GetContinuChargeData.prototype, "proto.s_GetContinuChargeData");
    var c_ReceiveRewards = (function (_super) {
        __extends(c_ReceiveRewards, _super);
        function c_ReceiveRewards() {
            var _this = _super.call(this) || this;
            //required>int
            _this.type = 0; //领取奖励的类型
            //required>int
            _this.id = 0; //领取奖励的ID
            _this.S = proto.MessageType.c_ReceiveRewards;
            return _this;
        }
        c_ReceiveRewards.prototype.init = function (_type, _id) {
            this.type = _type;
            this.id = _id;
            return this;
        };
        c_ReceiveRewards.prototype.encode = function (by) {
            by.writeInt(this.type);
            by.writeInt(this.id);
        };
        c_ReceiveRewards.prototype.decode = function (by) {
            this.type = by.readInt();
            this.id = by.readInt();
        };
        return c_ReceiveRewards;
    }(proto.Pro));
    proto.c_ReceiveRewards = c_ReceiveRewards;
    __reflect(c_ReceiveRewards.prototype, "proto.c_ReceiveRewards");
    var s_ReceiveRewards = (function (_super) {
        __extends(s_ReceiveRewards, _super);
        function s_ReceiveRewards() {
            var _this = _super.call(this) || this;
            //required>int
            _this.type = 0; //领取奖励的类型
            //required>int
            _this.id = 0; //领取奖励的ID
            _this.S = proto.MessageType.s_ReceiveRewards;
            return _this;
        }
        s_ReceiveRewards.prototype.init = function (_type, _id, _errMsg) {
            this.type = _type;
            this.id = _id;
            this.errMsg = _errMsg;
            return this;
        };
        s_ReceiveRewards.prototype.encode = function (by) {
            by.writeInt(this.type);
            by.writeInt(this.id);
            if (this.errMsg != null) {
                by.writeByte(1);
        ...
        s_ReceiveRewards.prototype.decode = function (by) {
            this.type = by.readInt();
            this.id = by.readInt();
            if (by.readByte() > 0) {
                this.errMsg = by.readUTF();
        ...
        return s_ReceiveRewards;
    }(proto.Pro));
    proto.s_ReceiveRewards = s_ReceiveRewards;
    __reflect(s_ReceiveRewards.prototype, "proto.s_ReceiveRewards");
    var c_GuildBattleReq = (function (_super) {
        __extends(c_GuildBattleReq, _super);
        function c_GuildBattleReq() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.c_GuildBattleReq;
            return _this;
        }
        c_GuildBattleReq.prototype.init = function () {
            return this;
        };
        c_GuildBattleReq.prototype.encode = function (by) {
        };
        c_GuildBattleReq.prototype.decode = function (by) {
        };
        return c_GuildBattleReq;
    }(proto.Pro));
    proto.c_GuildBattleReq = c_GuildBattleReq;
    __reflect(c_GuildBattleReq.prototype, "proto.c_GuildBattleReq");
    var s_GuildBattleReq = (function (_super) {
        __extends(s_GuildBattleReq, _super);
        function s_GuildBattleReq() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.s_GuildBattleReq;
            return _this;
        }
        s_GuildBattleReq.prototype.init = function (_isSuccess, _errMsg) {
            this.isSuccess = _isSuccess;
            this.errMsg = _errMsg;
            return this;
        };
        s_GuildBattleReq.prototype.encode = function (by) {
            by.writeBoolean(this.isSuccess);
            if (this.errMsg != null) {
                by.writeByte(1);
                by.writeUTF(this.errMsg);
        ...
        s_GuildBattleReq.prototype.decode = function (by) {
            this.isSuccess = by.readBoolean();
            if (by.readByte() > 0) {
                this.errMsg = by.readUTF();
            }
        };
        return s_GuildBattleReq;
    }(proto.Pro));
    proto.s_GuildBattleReq = s_GuildBattleReq;
    __reflect(s_GuildBattleReq.prototype, "proto.s_GuildBattleReq");
    var c_GuildChangeScene = (function (_super) {
        __extends(c_GuildChangeScene, _super);
        function c_GuildChangeScene() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.c_GuildChangeScene;
            return _this;
        }
        c_GuildChangeScene.prototype.init = function () {
            return this;
        };
        c_GuildChangeScene.prototype.encode = function (by) {
        };
        c_GuildChangeScene.prototype.decode = function (by) {
        };
        return c_GuildChangeScene;
    }(proto.Pro));
    proto.c_GuildChangeScene = c_GuildChangeScene;
    __reflect(c_GuildChangeScene.prototype, "proto.c_GuildChangeScene");
    var s_GuildChangeScene = (function (_super) {
        __extends(s_GuildChangeScene, _super);
        function s_GuildChangeScene() {
            var _this = _super.call(this) || this;
            //optional>int
            _this.sceneTemplateId = 0; //切换场景的模版ID
            _this.S = proto.MessageType.s_GuildChangeScene;
            return _this;
        }
        s_GuildChangeScene.prototype.init = function (_isSuccess, _errMsg, _sceneTemplateId) {
            this.isSuccess = _isSuccess;
            this.errMsg = _errMsg;
            this.sceneTemplateId = _sceneTemplateId;
            return this;
        };
        s_GuildChangeScene.prototype.encode = function (by) {
            by.writeBoolean(this.isSuccess);
            if (this.errMsg != null) {
                by.writeByte(1);
                by.writeUTF(this.errMsg);
            ...
            //基础类型不建议用optional
            by.writeByte(1);
            by.writeInt(this.sceneTemplateId);
        };
        s_GuildChangeScene.prototype.decode = function (by) {
            this.isSuccess = by.readBoolean();
            if (by.readByte() > 0) {
                this.errMsg = by.readUTF();
            }
            if (by.readByte() > 0) {
                this.sceneTemplateId = by.readInt();
            }
        };
        return s_GuildChangeScene;
    }(proto.Pro));
    proto.s_GuildChangeScene = s_GuildChangeScene;
    __reflect(s_GuildChangeScene.prototype, "proto.s_GuildChangeScene");
    var c_GuildAtkTarget = (function (_super) {
        __extends(c_GuildAtkTarget, _super);
        function c_GuildAtkTarget() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.c_GuildAtkTarget;
            return _this;
        }
        c_GuildAtkTarget.prototype.init = function (_targetInstId) {
            this.targetInstId = _targetInstId;
            return this;
        };
        c_GuildAtkTarget.prototype.encode = function (by) {
            by.writeUTF(this.targetInstId);
        };
        c_GuildAtkTarget.prototype.decode = function (by) {
            this.targetInstId = by.readUTF();
        };
        return c_GuildAtkTarget;
    }(proto.Pro));
    proto.c_GuildAtkTarget = c_GuildAtkTarget;
    __reflect(c_GuildAtkTarget.prototype, "proto.c_GuildAtkTarget");
    var C_Charge = (function (_super) {
        __extends(C_Charge, _super);
        function C_Charge() {
            var _this = _super.call(this) || this;
            //required>int
            _this.goodsId = 0; //商品id
            _this.S = proto.MessageType.C_Charge;
            return _this;
        }
        C_Charge.prototype.init = function (_goodsId) {
            this.goodsId = _goodsId;
            return this;
        };
        C_Charge.prototype.encode = function (by) {
            by.writeInt(this.goodsId);
        };
        C_Charge.prototype.decode = function (by) {
            this.goodsId = by.readInt();
        };
        return C_Charge;
    }(proto.Pro));
    proto.C_Charge = C_Charge;
    __reflect(C_Charge.prototype, "proto.C_Charge");
    var S_Charge = (function (_super) {
        __extends(S_Charge, _super);
        function S_Charge() {
            var _this = _super.call(this) || this;
            //required>int
            _this.goodsId = 0; //undefined
            _this.S = proto.MessageType.S_Charge;
            return _this;
        }
        S_Charge.prototype.init = function (_goodsId, _isSuccess, _errMsg) {
            this.goodsId = _goodsId;
            this.isSuccess = _isSuccess;
            this.errMsg = _errMsg;
            return this;
        };
        S_Charge.prototype.encode = function (by) {
            by.writeInt(this.goodsId);
            by.writeBoolean(this.isSuccess);
            by.writeUTF(this.errMsg);
        };
        S_Charge.prototype.decode = function (by) {
            this.goodsId = by.readInt();
            this.isSuccess = by.readBoolean();
            this.errMsg = by.readUTF();
        };
    ...
    proto.S_Charge = S_Charge;
    __reflect(S_Charge.prototype, "proto.S_Charge");
    var S_ChargeInfo = (function (_super) {
        __extends(S_ChargeInfo, _super);
        function S_ChargeInfo() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.S_ChargeInfo;
            return _this;
        }
        S_ChargeInfo.prototype.init = function (_chargeList) {
            this.chargeList = _chargeList;
            return this;
        };
        S_ChargeInfo.prototype.encode = function (by) {
            if (this.chargeList != null) {
                by.writeShort(this.chargeList.length);
                for (var i = 0; i < this.chargeList.length; i++) {
                    this.chargeList[i].encode(by);
                }
            }
            else {
                by.writeShort(0);
        ...
        S_ChargeInfo.prototype.decode = function (by) {
            var __count0 = by.readShort();
            this.chargeList = [];
            for (var i = 0; i < __count0; i++) {
                this.chargeList[i] = new ChargeData();
                this.chargeList[i].decode(by);
            }
        };
        return S_ChargeInfo;
    }(proto.Pro));
    proto.S_ChargeInfo = S_ChargeInfo;
    __reflect(S_ChargeInfo.prototype, "proto.S_ChargeInfo");
    var C_MonthCardExpire = (function (_super) {
        __extends(C_MonthCardExpire, _super);
        function C_MonthCardExpire() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.C_MonthCardExpire;
            return _this;
        }
        C_MonthCardExpire.prototype.init = function () {
            return this;
        };
        C_MonthCardExpire.prototype.encode = function (by) {
        };
        C_MonthCardExpire.prototype.decode = function (by) {
        };
        return C_MonthCardExpire;
    }(proto.Pro));
    proto.C_MonthCardExpire = C_MonthCardExpire;
    __reflect(C_MonthCardExpire.prototype, "proto.C_MonthCardExpire");
    var S_MonthCardExpire = (function (_super) {
        __extends(S_MonthCardExpire, _super);
        function S_MonthCardExpire() {
            var _this = _super.call(this) || this;
            //optional>int
            _this.expireTime = 0; //到期时间
            _this.S = proto.MessageType.S_MonthCardExpire;
            return _this;
        }
        S_MonthCardExpire.prototype.init = function (_isSuccess, _errMsg, _expireTime) {
            this.isSuccess = _isSuccess;
            this.errMsg = _errMsg;
            this.expireTime = _expireTime;
            return this;
        };
        S_MonthCardExpire.prototype.encode = function (by) {
            by.writeBoolean(this.isSuccess);
            if (this.errMsg != null) {
                by.writeByte(1);
                by.writeUTF(this.errMsg);
        ...
        S_MonthCardExpire.prototype.decode = function (by) {
            this.isSuccess = by.readBoolean();
            if (by.readByte() > 0) {
                this.errMsg = by.readUTF();
            }
        ...
        return S_MonthCardExpire;
    }(proto.Pro));
    proto.S_MonthCardExpire = S_MonthCardExpire;
    __reflect(S_MonthCardExpire.prototype, "proto.S_MonthCardExpire");
    var s_SyncSceneRole = (function (_super) {
        __extends(s_SyncSceneRole, _super);
        function s_SyncSceneRole() {
            var _this = _super.call(this) || this;
            _this.S = proto.MessageType.s_SyncSceneRole;
            return _this;
        }
        s_SyncSceneRole.prototype.init = function (_addUnitList) {
            this.addUnitList = _addUnitList;
            return this;
        };
        s_SyncSceneRole.prototype.encode = function (by) {
            if (this.addUnitList != null) {
                by.writeShort(this.addUnitList.length);
                for (var i = 0; i < this.addUnitList.length; i++) {
                    this.addUnitList[i].encode(by);
        ...
        s_SyncSceneRole.prototype.decode = function (by) {
            var __count0 = by.readShort();
            this.addUnitList = [];
            for (var i = 0; i < __count0; i++) {
                this.addUnitList[i] = new MyAction();
        ...
        return s_SyncSceneRole;
    }(proto.Pro));
    proto.s_SyncSceneRole = s_SyncSceneRole;
    __reflect(s_SyncSceneRole.prototype, "proto.s_SyncSceneRole");
    var ChargeData = (function (_super) {
        __extends(ChargeData, _super);
        function ChargeData() {
            var _this = _super.call(this) || this;
            //required>int
            _this.chargeTime = 0; //充值時間
            //required>int
            _this.chargeAmount = 0; //充值金額
            //required>int
            _this.money = 0; //对应的元宝，可能是0
            //required>int
            _this.chargeType = 0; //本次充值类型
            _this.S = proto.MessageType.ChargeData;
            return _this;
        }
        ChargeData.prototype.init = function (_chargeTime, _chargeAmount, _money, _chargeType) {
            this.chargeTime = _chargeTime;
            this.chargeAmount = _chargeAmount;
            this.money = _money;
            this.chargeType = _chargeType;
            return this;
        };
        ChargeData.prototype.encode = function (by) {
            by.writeInt(this.chargeTime);
            by.writeInt(this.chargeAmount);
            by.writeInt(this.money);
            by.writeInt(this.chargeType);
        };
        ChargeData.prototype.decode = function (by) {
            this.chargeTime = by.readInt();
            this.chargeAmount = by.readInt();
            this.money = by.readInt();
            this.chargeType = by.readInt();
        };
        return ChargeData;
    }(proto.Pro));
    proto.ChargeData = ChargeData;
    __reflect(ChargeData.prototype, "proto.ChargeData");
