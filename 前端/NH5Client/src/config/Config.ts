class Config {
	...
	/**版本号 */
	public static THMVERSION:string = "0.0.3";
	public static RESVERSION:string = "0.0.3";
	public static MOVIEVERSION:string = "0.0.3";
	...
	/**窗口中心 */
	public static w_halfWidth:number = 240;
	public static w_halfHiehgt:number = 400;

	/**单位地图块大小 */
	public static mapBlockWidth:number = 256;
	public static mapBlockHeight:number = 256;
