...
(function (temple) {
    var TempleMgr = (function () {
        ...
        //
        TempleMgr.getFunc = function (dataObj, url) {
            var regExp = /temple\/(\S*)\.txt/;
            var templeName = url.match(regExp)[1];
    ...
    temple.TempleMgr = TempleMgr;
    __reflect(TempleMgr.prototype, "temple.TempleMgr");
})(temple || (temple = {}));
