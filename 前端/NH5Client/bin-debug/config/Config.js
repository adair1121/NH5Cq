...
/**版本号 */
Config.THMVERSION = "0.0.3";
Config.RESVERSION = "0.0.3";
Config.MOVIEVERSION = "0.0.3";
/**测试用户 */
Config.username = "g42";
...
Config.w_height = 800;
/**窗口中心 */
Config.w_halfWidth = 240;
Config.w_halfHiehgt = 400;
/**单位地图块大小 */
Config.mapBlockWidth = 256;
Config.mapBlockHeight = 256;
/**默认装备资源路径 */
